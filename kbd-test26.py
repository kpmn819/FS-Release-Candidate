...
keys_with_leds_aux1 = (Data_Module3.park_brake)
...
def blit_new_bkg(bkg_file):
    ...
    if bkg_file == 'ap_page.png':
        ...
        # !!!!!!!!!!!!!!!!!!! need some way to allow buttons on other pages to work
        # !!!!!!!!!!!!!!!!!!! as it is now all leds from all pages will blit
